...
COL_MAP = {
    ...
    "sales": {
        "date":["date","invoice date","inv date","sale date"],
        "customer_name":["customer","customer name","client","client name","buyer"],
        "invoice_no":["invoice no","invoice number","inv no","inv #","ref"],
        "description":["description","desc","item","particulars"],
        "amount":["amount","net amount","subtotal","net"],
        "vat_amount":["vat","vat amount","tax"],
        "total_amount":["total","total amount","gross","grand total"],
    ...
    "purchase_returns": {
        ...
        "original_invoice_no":["original invoice","original invoice no","inv no","invoice no"],
        "return_reference":["return ref","return reference","credit note","cn no"],
        "description":["description","desc","reason detail","particulars"],
        "return_amount":["return amount","amount","credit amount","value"],
        "reason":["reason","return reason","cause"],
        "status":["status"],
        "notes":["notes","remarks"],
    },
    "collections": {
        "date":["date","collection date","payment date"],
        "customer_name":["customer","customer name","client","payer"],
        "amount_collected":["amount","amount collected","payment amount","collected"],
        "payment_method":["method","payment method","mode"],
        "reference_no":["reference","ref","ref no","reference no","receipt no"],
        "invoices_covered":["invoices","invoice covered","invoices covered","invoice no"],
        "collector_name":["collector","collected by","received by"],
        "notes":["notes","remarks"],
    },
    "banking": {
        "date":["date","value date","transaction date","txn date"],
        "description":["description","narration","particulars","details","remarks"],
        "reference_no":["reference","ref","ref no","cheque no","chq no","txn ref"],
        "type":["type","dr/cr","debit/credit","txn type"],
        "debit_amount":["debit","debit amount","dr","withdrawal","dr amount"],
        "credit_amount":["credit","credit amount","cr","deposit","cr amount"],
        "balance":["balance","closing balance","running balance"],
        "category":["category","cat","transaction type"],
        "notes":["notes","remarks"],
    },
    "expenses": {
        "date":["date","expense date","doc date"],
        "category":["category","expense category","type","expense type"],
        "description":["description","desc","particulars","details"],
        "amount":["amount","expense amount","value","cost"],
        "payment_method":["method","payment method","mode"],
        "paid_to":["paid to","payee","vendor","supplier"],
        "receipt_no":["receipt","receipt no","ref","reference"],
        "approved_by":["approved by","approver","authorized by"],
        "notes":["notes","remarks"],
    },
    "inventory": {
        "sku":["sku","item code","product code","code","part no"],
        "item_name":["item name","product","description","item","product name"],
        "category":["category","type","product type"],
        "unit_of_measure":["unit","uom","unit of measure","measure"],
        "opening_stock":["opening stock","opening","qty","quantity","stock"],
        "unit_cost":["unit cost","cost","cost price","purchase price"],
        "selling_price":["selling price","price","sale price","retail price"],
        "reorder_level":["reorder","reorder level","minimum stock","min stock"],
        "supplier_name":["supplier","vendor","supplier name"],
        "notes":["notes","remarks"],
    },
    "swap_deals": {
        "date":["date","swap date","deal date"],
        "party_a_name":["party a","party a name","giver","supplier"],
        "party_b_name":["party b","party b name","receiver","customer"],
        "item_a_given":["item a","item given","goods given","product given"],
        "value_a":["value a","amount a","value given"],
        "item_b_received":["item b","item received","goods received"],
        "value_b":["value b","amount b","value received"],
        "net_difference":["net","net difference","difference","balance"],
        "status":["status"],
        "notes":["notes","remarks"],
    },
    "sales_returns": {
        ...
        "original_invoice_no":["original invoice","invoice no","inv no"],
        "return_reference":["return ref","credit note","cn no"],
        "description":["description","desc","particulars"],
        "return_amount":["return amount","amount","value"],
