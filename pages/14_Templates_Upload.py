...
TEMPLATES = [
    ("01_Purchases_Template.xlsx",
     "🛒", "Purchases",
     "purchases",
     "Supplier invoices and purchase records — SKU, Qty, Rate"),
    ("02_Sales_Template.xlsx",
     "💰", "Sales",
     "sales",
     "Customer invoices and sales records — SKU, Qty, Rate"),
    ("03_Purchase_Returns_Template.xlsx",
     "↩️", "Purchase Returns",
     "purchase_returns",
     "Goods returned to suppliers — SKU, Qty, Rate"),
    ("04_Sales_Returns_Template.xlsx",
     "🔄", "Sales Returns",
     "sales_returns",
     "Goods returned by customers — SKU, Qty, Rate"),
    ("05_Collections_Template.xlsx",
     "💵", "Collections",
     "collections",
     "Cash and payment collections"),
    ("06_Bank_Statement_Template.xlsx",
     "🏦", "Bank Statement",
     "banking",
     "Bank transactions and reconciliation"),
    ("07_Inventory_Master_Template.xlsx",
     "📦", "Inventory",
     "inventory",
     "Stock and inventory master list"),
    ("08_Swap_Deals_Template.xlsx",
     "🔁", "Swap Deals",
     "swap_deals",
     "Barter and swap transactions"),
    ("09_Expenses_Template.xlsx",
     "💳", "Expenses",
     "expenses",
...
COL_MAP = {
    "purchases": {
        ...
        "supplier_name":     ["supplier","supplier name","vendor","vendor name","party","creditor","supplier_name"],
        "invoice_no":        ["invoice no","invoice number","inv no","inv #","ref","reference","reference_number","invoice_no"],
        "item_code":         ["item code","sku","item code (sku)","code","product code","part no","item_code"],
        "description":       ["description","desc","item","particulars","narration","details","product","item_description","item description"],
        "quantity":          ["quantity","qty","units","no of units","pcs","pieces","no. of units"],
        "rate":              ["rate","unit price","price","unit cost","cost per unit","rate per unit","unit_cost","unit_price"],
        "amount":            ["amount","net amount","subtotal","sub total","net","line total","net_amount"],
        "vat_amount":        ["vat","vat amount","tax","tax amount"],
        "total_amount":      ["total","total amount","gross","gross amount","grand total","invoice total","total_cost"],
        "payment_method":    ["payment method","method","mode","payment mode","payment_method"],
